...
struct Rules {
    ...
    let maximumNumberOfQuestions: Int
    ...
    ///   - maximumNumberOfQuestions: Number of questions that should be presented to the user **default value == 15**.
    ...
    init(
        ...
        self.maximumNumberOfQuestions = maximumNumberOfQuestion
